...
public class KMeansPlusPlus {
    ...
    private KMeansPlusPlus(Builder builder) {
        ...
        // run KMeansPlusPlus++ clustering algorithm
        run();
    ...
    /**
     * Builder class for constructing KMeansPlusPlus objects.
     *
    ...
    public static class Builder {
        ...
        public Builder(int k, double[][] points) {
            ...
            // check that there is a sufficient # of distinct points to run KMeansPlusPlus
    ...
    /**
     * Perform KMeansPlusPlus clustering algorithm once.
     */
     ...
     **********************************************************************/
    /**
     * Uses either plusplus (KMeansPlusPlus++) or a basic randoms sample to choose initial centroids
     */
    ...
    /**
     * Signals to stop running KMeansPlusPlus when the marginal improvement in WCSS
    ...
    public String getTiming() {
        return "KMeansPlusPlus++ took: " + (double) (end - start) / 1000.0 + " seconds";
    }
